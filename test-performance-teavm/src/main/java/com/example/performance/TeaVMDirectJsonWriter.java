...
/**
 * Direct JSON writer for TeaVM - uses DataHelper's generated methods.
 * Similar to DirectJsonWriter.java from JVM tests, but TeaVM-compatible.
 */
public class TeaVMDirectJsonWriter {
